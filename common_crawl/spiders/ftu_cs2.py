...
class FTU2Config:
  ...
  def __init__(self):
    self.title_css = [".entry-title"]
    self.content_css = [".td-post-content"]
...
class FTU2Spider(CrawlSpider):
    name = "ftu2"
    allowed_domains = ["cs2.ftu.edu.vn"]
    start_urls = ["https://cs2.ftu.edu.vn/"]
    rules = [
    ...
    def __init__(self, *a, **kw):
      super(FTU2Spider, self).__init__(*a, **kw)
      self.config = FTU2Config()
      print("Init")
